...
pipeline {
    ...
    stages {
        ...
        stage('Testing') {
            steps {
                echo "Testing..."
                sh "docker run -v '/home/jenkins/workspace/VF_IOT_MANAGED_CONNECTIVITY/Testing_Automation/Training Chapter/cypress-example':/e2e -w /e2e/ cypress/included:10.4.0 --spec cypress/integration/pom/homeSauce.spec.js --browser chrome --config-file cypress.json"
